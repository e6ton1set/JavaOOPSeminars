...
public class Main {
    public static void main(String[] args) {
        ...
        squadF.add(new Footman("Joe", 55, new Melee("Spear", 15)));
        squadF.add(new Footman("Moe", 100, new Melee("Sword", 44)));
        squadF.add(new Footman("doe", 20, new Melee("Incinerator", 25)));
        ...
        squadA.add(new Footman("Jack", 54, new Melee("Bow", 50)));
        squadA.add(new Footman("Jonathan", 54, new Melee("Crossbow", 120)));
        squadA.add(new Archer("Carl", 54, new Ranged("Axe", 90, 22)));
        ...
        Footman footman1 = new Footman("Mark", 77, new Melee("Book", 30));
        Footman footman2 = new Footman("Arch", 66, new Melee("Pin", 20));
